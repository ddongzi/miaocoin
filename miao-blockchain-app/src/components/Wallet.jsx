...
import { Button, CircularProgress, TextField, Typography, Box, Snackbar, IconButton, Container, Card, CardContent, Dialog, DialogActions, DialogContent, DialogTitle, List, ListItem, ListItemText, Menu, MenuItem } from '@mui/material';
import { CopyAll, MoreVert } from '@mui/icons-material';
import { getWalletInfo, transfer, getTransactionHistory } from '../apiService';
        ...
        <Container maxWidth="sm" style={{ paddingTop: '20px' }}>
            <Card>
                <CardContent>
                    ...
                    {wallet ? (
                        <div>
                            <Typography variant="h6">钱包余额: {wallet.balance} BTC</Typography>
                            <Box my={2}>
                                <TextField
                                    label="金额"
                                    type="number"
                ...
                <DialogContent>
                    <Box my={2}>
                        ...
                        <Box display="flex" alignItems="center">
                            ...
                            <IconButton onClick={() => handleCopy(wallet?.publicKey)} color="primary">
                                <CopyAll />
                            </IconButton>
                        </Box>
                    </Box>
                    <Box my={2}>
                        ...
                        <Box display="flex" alignItems="center">
                            ...
                            <IconButton onClick={() => handleCopy(wallet?.privateKey)} color="primary">
                                <CopyAll />
                            </IconButton>
                        </Box>
                    </Box>
            ...
            <Dialog open={openHistoryDialog} onClose={handleCloseHistoryDialog} fullWidth maxWidth="md">
